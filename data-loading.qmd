...
-   [load_alberta/create_db.py](https://github.com/egouge/cwf-alberta/blob/main/src/load_alberta/create_db.py)
    -- this script creates all the necessary database tables
-   [load_alberta/load_alberta.py](https://github.com/egouge/cwf-alberta/blob/main/src/load_alberta/load_alberta.py)
    -- this script uses OGR to load the provided Alberta data from the
    .gdb file into the PostgreSQL database.
...
[load_alberta/create_db.py](https://github.com/egouge/cwf-alberta/blob/main/src/load_alberta/create_db.py#L159).
...
Data preparation is completed by watershed ID, each watershed is
processed into a separate schema in the database named after the
watershed identifier (e.g., ws17010301 for the Berland River).
